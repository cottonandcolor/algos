...
public class Nasa2 {
    ...
    private static Date callNasaGetLatest(final String output) throws IOException, ParseException, org.json.simple.parser.ParseException {
        ...
        long[] timeinterval = new long[imgDates.size()];
        ...
        System.out.println("avgDelta=" + avgDelta);
        ...
        System.out.println("count=" + (1 + delta/avgDelta));
        Calendar cal1 = Calendar.getInstance();
        cal1.setTime(lastDate);
        cal1.setTimeInMillis(lastDate.getTime() +  (avgDelta * (1 + delta/avgDelta)));
        return cal1.getTime();
